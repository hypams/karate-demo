    ...
    return {
        ...
        feature: function(app, name, feature = "") {
            if (feature) {
                ...
                return resource.featurePath(app, businessName, featureName)
            }
        },
        ...
        locator: function(app, name, platform = "") {
            ...
            var defaultCommonPath = resource.defaultLocatorPath(app, commonName, commonName)
            var commonPath = resource.locatorPath(app, commonName, platform)
            var defaultTargetPath = resource.defaultLocatorPath(app, name, name)
            var targetPath = resource.locatorPath(app, name, platform)
